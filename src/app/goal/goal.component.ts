...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    ...
    new Goal(7,'Get a Scholarship at Harvard University','Get approved for the Scholarship',new Date(2017,12,20)),
  ];
  ...
  deleteGoal(isComplete, index){
    let toDelete = confirm(`Are yu sure you want to delete ${this.goals[index].name}?`)
